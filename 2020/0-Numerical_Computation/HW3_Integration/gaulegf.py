...
def gausLegInt(a, b, n):
    x, w = gaulegf(a, b, n)

    result = 0.0

    for i in range(1,n+1):
        result = result + w[i]*math.sin(x[i])

    return result
    #END gaussLegIntegration


if __name__ == "__main__":
    print("gaulegf.py running")
    print(gausLegInt(0,1,8))
    print("gaulegf.py finished")
else:
    print("Loaded gaulegf.py")
